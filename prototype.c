  ...
  while (1)
  {
    ...
    /* USER CODE BEGIN 3 */
	  //button 1
	  	  ...
	  	  //button 2
	  	  if(HAL_GPIO_ReadPin(GPIOB, GPIO_PIN_13) == GPIO_PIN_RESET){ //reset
	  	  ...
	  	  //button 3
	  	  if(HAL_GPIO_ReadPin(GPIOB, GPIO_PIN_14) == GPIO_PIN_RESET){ //record
	  	  ...
	  	  //button 4
	  	  if(HAL_GPIO_ReadPin(GPIOB, GPIO_PIN_15) == GPIO_PIN_RESET){ //lane switch
